...
test("all-market mode is bounded and does not multiply query variations", async () => {
  ...
  assert.match(client, /maxCandidates: allMarketsMode \? 2 : marketplace === "Grailed" \? 8 : marketplace === "Depop" \? 12 : 4/);
  assert.match(client, /maxWorkers: allMarketsMode \? 1 : 3/);
});

test("marketplace relay permits supported sources including Depop", async () => {
