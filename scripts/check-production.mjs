...
if (health.revision !== "production-navigation-markets-v14") {
...
if (!/official-page-source-relay/i.test(relayResult.response.headers.get("x-rml-marketplace-mode") || "")) {
  throw new Error("The marketplace endpoint is not serving the v14 bounded official page-source transport.");
}
