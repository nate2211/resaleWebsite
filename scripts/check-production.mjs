...
if (health.revision !== "market-search-url-recovery-production-v17") {
...
if (!/official-page-source-relay/i.test(relayResult.response.headers.get("x-rml-marketplace-mode") || "")) {
  throw new Error("The marketplace endpoint is not serving the v17 bounded official page-source transport.");
}
